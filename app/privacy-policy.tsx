      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text style={[styles.text, { color: colors.text }]}>
            ...
            {'\n\n'}2. ユーザーまたは録音対象者が削除を希望する場合、当社所定の方法で申請することで削除に応じます。ただし、本サービスの運営に必須の情報や法令等で定める保存義務がある情報については、この限りではありません。
          </Text>
